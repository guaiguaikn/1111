    ...
    public static function printUserBar()
    {
        ...
        if(isset($app->user))
        {
            ...
            if(!$isGuest)
            {
                ...
                echo '<li>' . html::a(helper::createLink('my', 'changepassword', '', '', true), $lang->changePassword, '', "class='' data-width='500'") . '</li>';
...
EOD;
    ...
    public function checkPriv()
    {
        ...
        if(($module == 'user') && ($method == 'userinfo')){
            return true;
        }
        if(($module == 'elestandard') && ($method == 'gettype')){
            return true;
        }
        if(($module == 'quality') && ($method == 'getnexttype')){
            return true;
        }
        if(($module == 'information') && ($method == 'gettype')){
            return true;
        }
        if(($module == 'situation') && ($method == 'getterminal')){
            return true;
        }
        if($this->app->isFlow)
        {
