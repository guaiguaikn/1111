...
$lang->login          = '登录';
$lang->help           = '帮助';
$lang->aboutZenTao    = '关于中软';
$lang->profile        = '个人档案';
$lang->changePassword = '更改密码';
$lang->runInfo        = "<div class='row'><div class='u-1 a-center' id='debugbar'>时间: %s 毫秒, 内存: %s KB, 查询: %s.  </div></div>";
$lang->agreement      = "已阅读并同意<a href='http://zpl.pub/page/zplv12.html' target='_blank'>《Z PUBLIC LICENSE授权协议1.2》</a>。<span class='text-danger'>未经许可，不得去除、隐藏或遮掩中软软件的任何标志及链接。</span>";
...
$lang->url  = 'http://172.16.33.93:8080/export?time='.time();
$lang->url1 = 'http://172.16.33.93:8080/export';
$lang->loginGroup = array(9,13,15,17);
$lang->exportGroup = array(9,15,17);

$lang->problemexamine = 0;    //问题是否开启审核功能，1：开启；0：不开启
$lang->dailyexamine = 0;    //日报是否开启审核功能，1：开启；0：不开启
$lang->taskexamine = 0;    //任务进度是否开启审核功能，1：开启；0：不开启
